    ...
    <section class="other-attention-sec">
        <div class="container">
            <dl class="refound-policy">
                <dt>返品・返金ポリシー</dt>
                <dd>お客さま都合による返品は、お受けいたしておりません。<br>商品の発送には十分注意しておりますが、商品違いや郵送時による初期破損は、商品到日より7日以内にご連絡ください。その他不具合（糸のほつれなど）があった場合は、商品到日より30日以内に、メールまたはお電話にてお問合せください。不具合状況確認の上、良品と交換させていただきます。</dd>
